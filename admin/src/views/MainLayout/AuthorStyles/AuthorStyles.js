...
import EditAuthorStylesModal from '../../../components/EditAuthorStylesModal/EditAuthorStylesModal'
import RecordsTable, {
...
const AuthorStyles = () => {
	...
	return (
		<div className="AuthorStyles page">
			<PageContextMenu title="Author Styles" />
				...
				<LoadingBlocker loading={recordsTableController.state.loading}>
					<div className="statistics">
						<div>
							<ul>
								<li>
									<strong>Archived Author Styles: </strong>
									<span>{statistics?.totalArchivedCount}</span>
								</li>
								<li>
									<strong>Non-Archived Author Styles: </strong>
									<span>{statistics?.totalNonArchivedCount}</span>
								</li>
								<li>
									<strong>Global Author Styles: </strong>
									<span>{statistics?.totalGlobalCount}</span>
								</li>
								<li>
									<strong>User Author Styles: </strong>
									<span>{statistics?.totalUserCreatedCount}</span>
								</li>
								<li>
									<strong>Total Author Styles: </strong>
