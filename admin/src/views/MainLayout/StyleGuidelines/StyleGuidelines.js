...
import EditStyleGuidelinesModal from '../../../components/EditStyleGuidelinesModal/EditStyleGuidelinesModal'
...
const StyleGuidelines = () => {
	...
	return (
		<div className="StyleGuidelines page">
			<PageContextMenu title="Style Guidelines" />
				...
				<LoadingBlocker loading={recordsTableController.state.loading}>
					<div className="statistics">
						<div>
							<ul>
								<li>
									<strong>Archived Style Guidelines: </strong>
									<span>{statistics?.totalArchivedCount}</span>
								</li>
								<li>
									<strong>Non-Archived Style Guidelines: </strong>
									<span>{statistics?.totalNonArchivedCount}</span>
								</li>
								<li>
									<strong>Global Style Guidelines: </strong>
									<span>{statistics?.totalGlobalCount}</span>
								</li>
								<li>
									<strong>User Style Guidelines: </strong>
									<span>{statistics?.totalUserCreatedCount}</span>
								</li>
								<li>
									<strong>Total Style Guidelines: </strong>
