...
test('tests Author Styles page', async () => {
	...
	// navigate to Author Styles page
	const pageLink = baseElement.querySelector('a[href="/author-styles"]')
	...
	expect(getElementText(pageTitle)).toBe('Author Styles')
	...
	// test Author Styles page
	const addRecordButton = screen.getByText('Add Author Style')
	expect(addRecordButton).toBeInTheDocument()
	userEvent.click(addRecordButton)
	await new Promise((r) => setTimeout(r, 100))

	// test Author Styles add
