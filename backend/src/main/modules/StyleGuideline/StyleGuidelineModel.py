...
class StyleGuidelineModel(EncryptedDocument, FilteredDictionary):
    """
    This is the StyleGuidelineModel class that represents the style guideline document in MongoDB.

    The class has the following fields:
    - name (StringField): The name of the style guideline. It is a required field.
    - prompt_text (StringField): The prompt text field to elicit the style guideline. It is a required field.
    - user_id (IntField): The id for the owning user, or 'None' if global. It is a required field.
    - active (BoolField): If the style guideline is available to users. It is a required field.
    - created_at (DateTimeField): The date and time when the style guideline was created.
                                  By default, it is set to the current date and time.
    - modified_at (DateTimeField): The date and time when the style guideline was last modified.
    """
    meta = {
        'collection': 'style_guidelines',
