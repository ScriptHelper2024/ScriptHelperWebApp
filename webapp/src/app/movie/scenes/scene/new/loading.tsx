  ...
  <>
    ...
    <div className="col-start-4 row-span-full row-start-2 h-full relative">
      <div className="flex flex-col justify-center items-center gap-5 bg-white px-2 py-3 rounded-full border-[1px] border-light w-fit top-[50%] translate-y-[-50%] absolute z-40 group">
        <div className="rounded-full w-[28px] h-[28px] flex justify-center items-center transition">
          <MdOutlineMovieCreation className="text-white" size={14} />
        </div>

        <div>
          <div className="bg-secondary hover:bg-secondary-hover rounded-full w-[28px] h-[28px] flex justify-center items-center">
        ...
        <div className="absolute -bottom-16 p-8 pt-4 transition-opacity">
          <div className="rounded-full bg-secondary hover:bg-secondary-hover text-white p-1">
            <MdClose size={14} />
          </div>
        </div>
      </div>
